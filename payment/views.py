...
from courses.models import Pricing, Subscription
...
class PaymentView(View): 
    def get(self, request, slug, *args, **kwargs):
        ...
        if subscription.price == pricing and subscription.is_active:
            messages.info(request, "Ya tienes esta subscripción")
...
class CreateSubscriptionView(APIView):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            #configurar metodod de pago prederterminado del cliente
...
def webhook(request):
    ...
    if event_type == 'invoice.paid':
        ...
        user.subscription.price = pricing
